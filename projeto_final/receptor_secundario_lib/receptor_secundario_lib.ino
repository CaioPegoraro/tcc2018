...
double angulo_y,erro;
double throttle=1300;
double intensidade_esquerda,intensidade_direita;
...
void loop() {
  ...
  if(flag_controle==1){
    ...
    if((angulo_y > 50) || (angulo_y <-50)){
      ...
      if(angulo_y<0){
        intensidade_esquerda = throttle + Output;
        intensidade_direita = throttle - Output;
      }
      else{
        intensidade_esquerda = throttle - Output;
        intensidade_direita = throttle + Output;
